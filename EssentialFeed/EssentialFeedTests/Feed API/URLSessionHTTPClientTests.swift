...
final class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_getFromURL_suceedsOnHTTPURLResponseWithData() {
        ...
        XCTAssertEqual(givenData, receivedValues?.data)
        XCTAssertEqual(givenResponse.url, receivedValues?.response.url)
        XCTAssertEqual(givenResponse.statusCode, receivedValues?.response.statusCode)
    }
