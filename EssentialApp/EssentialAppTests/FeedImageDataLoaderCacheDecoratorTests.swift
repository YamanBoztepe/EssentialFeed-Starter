...
final class FeedImageDataLoaderCacheDecoratorTests: XCTestCase, FeedImageDataLoaderTestCase {
    ...
    func test_loadImageData_cachesLoadedDataOnLoaderSuccess() {
        ...
        XCTAssertEqual(cache.messages, [.save(data: anyData(), for: anyURL())], "Expected to cache data on success")
    }
    ...
    func test_loadImageData_doesNotCacheOnLoaderFailure() {
        ...
        XCTAssertTrue(cache.messages.isEmpty, "Expected not to cache data on failure")
    }
