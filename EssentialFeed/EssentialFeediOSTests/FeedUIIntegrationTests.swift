...
final class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_loadFeedActions_requestFeedFromLoader() {
        ...
        XCTAssertEqual(loader.loadFeedCallCount, 0, "Expected to not request the feed before the view appears")
        
        sut.completeViewLifeCycle()
        XCTAssertEqual(loader.loadFeedCallCount, 1, "Expected to load the feed when the view appears")
        
        sut.simulateUserInitiatedFeedReload()
        XCTAssertEqual(loader.loadFeedCallCount, 2, "Expected to reload the feed when requested")
        
        sut.simulateUserInitiatedFeedReload()
        XCTAssertEqual(loader.loadFeedCallCount, 3, "Expected to reload the feed when requested again")
    }
    ...
    func test_feedImageView_doesNotRenderLoadedImageWhenNotVisibleAnymore() {
        ...
        XCTAssertNil(view?.renderedImage, "Expected no image to be rendered when view is not visible anymore")
    }
